...
public class EmpApp {
	public static void main(String[] args) {
		...
		Emp emp = new Emp(8001, "javaboy", "CLERK", 7902, null, 1000, 0, 20);
//		dao.register(emp);
		
//		System.out.println(dao.get(8000));
//		System.out.println(dao.modify(new Emp(8000, "javaboy1", null, 0, null, 2000, 0, 0)));
//		System.out.println(dao.get(8000));
//		
//		
//		System.out.println(dao.get(8000));
...
//		System.out.println(dao.remove(8001));

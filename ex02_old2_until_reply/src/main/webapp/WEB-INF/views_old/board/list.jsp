...
<%-- 		<label><input type="checkbox" name="typeArr" value="T" ${fn:contains(page.cri.type, 'T') ? 'checked' : '' } checked>제목</label>
	...
	<c:if test="${page.prev}">
		<a href="list?${page.cri.paramsWithoutPageNum}&PageNum=${page.start-1}">prev</a>
	</c:if>
